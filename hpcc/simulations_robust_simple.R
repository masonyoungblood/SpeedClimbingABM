...
SpeedClimbingABM_slurm <- function(innov_prob, innov_x_year, learn_prob, learn_x_year, n_top, improve_rate_m, constraint_b){
...
for(i in 1:rounds){
  if(i == 1){
    ...
    rm(list = c("innov_prob_post", "innov_x_year_post", "learn_prob_post", "learn_x_year_post", 
