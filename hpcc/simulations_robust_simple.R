...
obs_stats <- SpeedClimbingABM(n = n, years = years, pop_data = pop_data, grid = grid, n_holds = 20,
                              ...
                              innov_x_year = -1, learn_x_year = -1,
                              n_top = 0.2, max_dist = 1.645, improve_rate_m = 2,
                              constraint_a = 0.5, constraint_b = 0.5,
...
SpeedClimbingABM_slurm <- function(innov_prob, learn_prob, innov_x_year, learn_x_year, n_top, improve_rate_m, constraint_a, constraint_b){
  temp <- SpeedClimbingABM(n = n, years = years, pop_data = pop_data, grid = grid, n_holds = 20,
                           ...
                           innov_x_year = innov_x_year, learn_x_year = learn_x_year,
...
for(i in 1:rounds){
  if(i == 1){
    ...
    rm(list = c("innov_prob_post", "learn_prob_post", "innov_x_year_post", "learn_x_year_post", 
                "n_top", "improve_rate_m_post", "constraint_a", "constraint_b"))
  }
