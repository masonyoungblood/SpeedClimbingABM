...
for(i in 1:rounds){
  if(i == 1){
    ...
    improve_rate_m_post <- density(params$improve_rate_m[order(results)[1:(n_sim*tol)]], from = 1, to = 3, n = 2^12, bw = "SJ")
    improve_rate_sd_post <- density(params$improve_rate_sd[order(results)[1:(n_sim*tol)]], from = 0, n = 2^12, bw = "SJ")
