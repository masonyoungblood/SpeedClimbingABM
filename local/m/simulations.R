...
# save(priors_and_simulations, file = "local/m/priors_and_simulations.RData")

#load data
load("local/m/priors_and_simulations.RData")
...
# 
# #save it
# save(sum_stats, file = "local/m/sum_stats.RData")
...
# 
# #save abc models
# save(tuning, file = "local/m/tuning.RData")

#load data
load("local/m/tuning.RData")
...
for(x in 1:4){
  ...
  #save model
  save(model, file = paste0("local/m/models/", colnames(priors)[x], "_model.RData"))
